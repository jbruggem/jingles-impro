...
namespace TagLib {
  ...
  public:
	 ...
	 * default.
	 */
	ByteVector(uint32_t size, char value = 0);
	 ...
	 */
	ByteVector(const char *data, uint32_t length);
	 ...
	 */
	ByteVector &setData(const char *data, uint32_t length);
	 ...
	 */
	ByteVector mid(uint32_t index, uint32_t length = 0xffffffff) const;
	 ...
	 */
	int find(const ByteVector &pattern, uint32_t offset = 0, int byteAlign = 1) const;
	 ...
	 */
	int rfind(const ByteVector &pattern, uint32_t offset = 0, int byteAlign = 1) const;
	 ...
	 */
	bool containsAt(const ByteVector &pattern, uint32_t offset, uint32_t patternOffset = 0, uint32_t patternLength = 0xffffffff) const;
	 ...
	 */
	ByteVector &resize(uint32_t size, char padding = 0);
	 ...
	 * \see fromUInt()
	 */
	uint32_t toUInt(bool mostSignificantByteFirst = true) const;
	 ...
	 * \see toUInt()
	 */
	static ByteVector fromUInt(uint32_t value, bool mostSignificantByteFirst = true);
	 ...
	 */
	static ByteVector fromCString(const char *s, uint32_t length = 0xffffffff);
...
namespace TagLib {
  ...
  public:
	 ...
	 */
	String substr(uint32_t position, uint32_t n = 0xffffffff) const;
...
namespace TagLib {
  ...
  public:
	 ...
	 */
	virtual void setYear(uint32_t i) = 0;

	/*!
	 * Sets the track to \a i.  If \a s is 0 then this value will be cleared.
	 */
	virtual void setTrack(uint32_t i) = 0;
...
template <class T>
const T &List<T>::operator[](uint32_t i) const
{
...
namespace TagLib {
  ...
  namespace ID3v2 {
	...
	public:
	   ...
	   */
	  static uint32_t headerSize(); // BIC: remove and make non-static
	   ...
	   */
	  static uint32_t headerSize(uint32_t version); // BIC: remove and make non-static
	...
	protected:
	  ...
	  // BIC: remove and make non-static
	  static String::Type checkEncoding(const StringList &fields,
										String::Type encoding, uint32_t version);
	...
	public:
	   ...
	   */
	  explicit Header(const ByteVector &data, uint32_t version = 4);
	   ...
	   */
	  void setData(const ByteVector &data, uint32_t version = 4);
...
namespace TagLib {
  ...
  namespace ID3v2 {
	...
	public:
	   ...
	   * users.
	   */
	  void setMajorVersion(uint32_t version);
	   ...
	   * \see tagSize()
	   */
	  uint32_t completeTagSize() const;

	  /*!
	   * Set the tag size to \a s.
	   * \see tagSize()
	   */
	  void setTagSize(uint32_t s);
...
namespace TagLib {
  ...
  namespace ID3v2 {
	...
	namespace SynchData
	{
	   ...
	   */
	  TAGLIB_EXPORT uint32_t toUInt(const ByteVector &data);

	  /*!
	   * Returns a 4 byte (32 bit) synchsafe integer based on \a value.
	   */
	  TAGLIB_EXPORT ByteVector fromUInt(uint32_t value);
...
namespace TagLib {
  ...
  namespace ID3v2 {
	...
	public:
	   ...
	   * instance in new code.
	   */
	  Frame *createFrame(const ByteVector &data, uint32_t version = 4) const;
...
namespace TagLib {
  ...
  namespace Ogg {
	...
	public:
	   ...
	   */
	  ByteVector packet(uint32_t i);

	  /*!
	   * Sets the packet with index \a i to the value \a p.
	   */
	  void setPacket(uint32_t i, const ByteVector &p);
...
namespace TagLib {
  ...
  namespace Ogg {
	...
	public:
	   ...
	   */
	  uint32_t streamSerialNumber() const;
	   ...
	   */
	  void setStreamSerialNumber(uint32_t n);
...
namespace TagLib {
  ...
  namespace MPC {
	...
	static const uint32_t HeaderSize = 8*7;
...
namespace TagLib {
  ...
  namespace WavPack {
	...
	static const uint32_t HeaderSize = 32;
...
namespace TagLib {
  ...
  namespace RIFF {
	...
	protected:
	   ...
	   */
	  ByteVector chunkData(uint32_t i);
  ...
  namespace RIFF {
	...
	namespace WAV {
	  ...
	  public:
		 ...
		 */
		Properties(const ByteVector &data, uint32_t streamLength, ReadStyle style);
...
namespace TagLib {
  ...
  namespace Mod {
	...
	protected:
	  ...
	  void writeU16L(uint16_t number);
	  void writeU32L(ulong number);
	  void writeU16B(uint16_t number);
	  void writeU32B(ulong number);

	  bool readString(String &s, ulong size);
	  bool readByte(uchar &byte);
	  bool readU16L(uint16_t &number);
	  bool readU32L(ulong &number);
	  bool readU16B(uint16_t &number);
...
namespace TagLib {
  ...
  namespace Mod {
	...
	public:
	  ...
	  void setInstrumentCount(uint32_t sampleCount);
...
namespace TagLib {
  namespace IT {
	...
	public:
	  ...
	  uint16_t lengthInPatterns()  const;
	  bool   stereo()            const;
	  uint16_t instrumentCount()   const;
	  uint16_t sampleCount()       const;
	  uint16_t patternCount()      const;
	  uint16_t version()           const;
	  uint16_t compatibleVersion() const;
	  uint16_t flags()             const;
	  uint16_t special()           const;
	  ...
	  void setChannels(int channels);
	  void setLengthInPatterns(uint16_t lengthInPatterns);
	  ...
	  void setCompatibleVersion(uint16_t compatibleVersion);
	  void setFlags       (uint16_t flags);
	  void setSpecial     (uint16_t special);
...
namespace TagLib {
  namespace S3M {
	...
	public:
	  ...
	  uint16_t patternCount()      const;
	  uint16_t flags()             const;
	  uint16_t trackerVersion()    const;
	  uint16_t fileFormatVersion() const;
	  uchar  globalVolume()      const;
	  ...
	  void setPatternCount     (uint16_t patternCount);
	  void setFlags            (uint16_t flags);
	  void setTrackerVersion   (uint16_t trackerVersion);
	  void setFileFormatVersion(uint16_t fileFormatVersion);
	  void setGlobalVolume     (uchar globalVolume);
...
namespace TagLib {
  namespace XM {
	...
	public:
	  ...
	  uint16_t lengthInPatterns() const;
	  uint16_t version()          const;
	  uint16_t restartPosition()  const;
	  uint16_t patternCount()     const;
	  uint16_t instrumentCount()  const;
	  uint32_t   sampleCount()      const;
	  uint16_t flags()            const;
	  uint16_t tempo()            const;
	  uint16_t bpmSpeed()         const;
	  ...
	  void setBpmSpeed(uint16_t bpmSpeed);
